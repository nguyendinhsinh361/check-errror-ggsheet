...
class Kind_D7_Service:
    ...
    def J7(self, audio_question, text_question):
        arr_error = []
    ...
    def run(self):
        ...
        arr_error = [
            ...
            self.J7(kind_data["audio_question"], kind_data["text_question"]),
            ...
            self.S7(kind_data["corect_answer"]),
            self.T7(kind_data["explain"], kind_data["answer"], kind_data["corect_answer"],

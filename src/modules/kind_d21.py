...
class Kind_D21_Service:
    ...
    def T21(self, explain, text_question, answer, corect_answer, kana_answer, romanji_answer):
        arr_error = []
        if not helper.check_T21_complete_sentences_drop_text_combining_correct_answer(explain, answer, corect_answer):
            arr_error.append(34)
        if not helper.check_T21_complete_sentences_drop_text_combining_kana_answer(explain, kana_answer, corect_answer):
            arr_error.append(35)
        if not helper.check_T21_complete_sentences_drop_text_combining_romanji_answer(explain, romanji_answer, corect_answer):
            arr_error.append(36)
    ...
    def run(self):
        ...
        arr_error = [
            ...
            self.S21(kind_data["corect_answer"]),
